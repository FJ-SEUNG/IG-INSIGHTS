...
- 카드 내용: 카드당 25자 이내로 작성
- 단, 수치/가격/시간/날짜/노선명 등 필수 디테일은 반드시 포함
...
[응답 형식] 반드시 JSON만 출력:
{
  ...
  "cards": [
    {"title": "10자 이내", "content": "25자 이내 핵심 정보(필수 디테일 포함)", "alt_text": "이미지 설명 1문장"},
    {"title": "10자 이내", "content": "25자 이내 핵심 정보", "alt_text": "이미지 설명"},
    {"title": "10자 이내", "content": "25자 이내 핵심 정보", "alt_text": "이미지 설명"},
    {"title": "10자 이내", "content": "25자 이내 핵심 정보", "alt_text": "이미지 설명"},
    {"title": "10자 이내", "content": "25자 이내 꿀팁/주의사항", "alt_text": "이미지 설명"}
  ],
  "caption": "인스타그램 기준 4~5줄 요약 + 자세한 내용은 카드뉴스 확인 유도",
