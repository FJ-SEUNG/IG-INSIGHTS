...
[카드뉴스 작성 규칙 - 매우 중요!]
- 카드 제목: 최대 8자 이내 (예: "사건 개요", "운행 정보")
- 카드 내용: 최대 30자 이내로 짧고 간결하게!
- 한 카드에 핵심 정보 1개만 담기
- 긴 문장 금지! 짧은 문장으로 작성

[본문(caption) 작성 규칙 - 매우 중요!]
- 원본의 모든 중요 정보를 빠짐없이 포함하세요
- 구체적인 숫자와 팩트를 유지하세요 (날짜, 시간, 장소, 인물 등)
- 정보를 함축하지 말고 디테일하게 풀어서 설명하세요
...
반드시 한국어로 JSON 형식으로만 응답:
{
  ...
  "cards": [
    {"title": "8자 이내", "content": "30자 이내 짧은 내용"},
    {"title": "8자 이내", "content": "30자 이내 짧은 내용"},
    {"title": "8자 이내", "content": "30자 이내 짧은 내용"},
    {"title": "8자 이내", "content": "30자 이내 짧은 내용"}
  ],
  "caption": "# 제목\\n\\n도입부 요약 2-3문장\\n\\n# 상세 내용 1\\n구체적 정보 디테일하게 (날짜, 시간, 장소 포함)\\n\\n# 상세 내용 2\\n추가 정보 상세히\\n\\n# 주의사항/팁\\n관련 정보\\n\\n📌 저장 필수!\\n\\n🙌🏻 일본 여행 정보 더 보고 싶다면?\\n✔️ @flyingjapan 팔로우하기!\\n✔️ 댓글에 '정보' 남겨주세요\\n\\nDM으로 정보 보내드려요 💙",
...
[카드뉴스 작성 규칙 - 매우 중요!]
- 카드 제목: 최대 8자 이내 (예: "사건 개요", "피해 상황")
- 카드 내용: 최대 30자 이내로 짧고 간결하게!
- 한 카드에 핵심 정보 1개만 담기
- 긴 문장 금지! 짧은 문장으로 끊어서 작성

[본문(caption) 작성 규칙 - 매우 중요!]
- 원본의 모든 중요 정보를 빠짐없이 포함하세요 (날짜, 시간, 장소, 인물, 상황, 결과 등)
- 구체적인 숫자와 팩트를 그대로 유지하세요
- 정보를 함축하지 말고 디테일하게 풀어서 설명하세요
- 섹션별로 나눠서 읽기 쉽게 구성하세요
...
반드시 한국어로 JSON 형식으로만 응답:
{
  ...
  "thumbnail_title": "메인 타이틀 16자 이내 (이모지 포함)",
  "cards": [
    {"title": "8자 이내 제목", "content": "30자 이내 짧은 내용"},
    {"title": "8자 이내 제목", "content": "30자 이내 짧은 내용"},
    {"title": "8자 이내 제목", "content": "30자 이내 짧은 내용"},
    {"title": "8자 이내 제목", "content": "30자 이내 짧은 내용"}
  ],
  "caption": "# 제목\\n\\n도입부 (사건/정보 요약 2-3문장)\\n\\n# 상세 내용 1\\n원본의 구체적 정보를 다른 표현으로 상세히 작성 (날짜, 시간, 장소 등 포함)\\n\\n# 상세 내용 2\\n추가 정보나 경과를 디테일하게 작성\\n\\n# 상세 내용 3\\n관련 정보나 주의사항 상세히 작성\\n\\n📌 저장해두고 참고하세요!\\n\\n🙌🏻 일본 여행 정보 더 보고 싶다면?\\n✔️ @flyingjapan 팔로우하기!\\n✔️ 댓글에 '정보' 남겨주세요\\n\\nDM으로 정보 보내드려요 💙",
  "hashtags": ["#일본여행", "#플라잉재팬", "... 총 15개"],
  "image_keyword": "영어 키워드"
}
